...
/**
 * 运营分析-网站折线图数据库查询结果dto
 * @author cpc
 * @create 2019-04-08 18:11
 **/
public class OAWebChatLineDTO implements Serializable {
    private Long pv;
    private Long uv;
    private Long day;

    public OAWebChatLineDTO() {
    }

    public OAWebChatLineDTO(Long pv, Long uv) {
        this.pv = pv;
        this.uv = uv;
    }
    ...
    public boolean equals(Object o) {
        ...
        OAWebChatLineDTO that = (OAWebChatLineDTO) o;
